...
class ApprovalRequestBadge
  ...
  def label_text
    I18n.t("approval_request.badges.#{tag}")
  end
...
class ApprovalRequestPresenter < SimpleDelegator
  include ActionView::Helpers::FormTagHelper
  include Rails.application.routes.url_helpers

  BADGES = {
    approved: ApprovalRequestBadge.new("approved", "label-success"),
    expired: ApprovalRequestBadge.new("expired", "label-danger"),
    sent: ApprovalRequestBadge.new("sent", "label-default"),
    unsent: ApprovalRequestBadge.new("unsent", "label-warning")
  }.freeze
  ...
  def approver_link
    link_to approver, edit_approval_request_path(approver)
  end
